...
public class ProjectTests {
  ...
  private static final String FOO = "aoo";
  ...
  public void testContains() {
    assertTrue(oneNodeTree.contains("blabla"));
  }
  ...
  @Test
  public void testGet() {
    assertEquals("blabla", oneNodeTree.get("blabla"));
  }
  ...
  public void testGetMaximum() {
    assertEquals("x", oneNodeTree.getMaximum());
  }
  ...
  public void testEquals() {
    ...
    assertTrue(emptyTree.equals(tree));
